    ...
    <section className="bg-[#FAFAFA] min-h-screen py-[clamp(100px,15vh,220px)]">
      ...
      <div className="w-[92%] max-w-[1500px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[clamp(60px,8vw,160px)] items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          {/* Button */}
          <button className="bg-[#1F1F1F] text-white px-[clamp(24px,3vw,50px)] py-[clamp(12px,1.5vh,22px)] rounded-full text-[clamp(14px,1vw,18px)] font-medium hover:opacity-90 transition">
            Full article here
          </button>
